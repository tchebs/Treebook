...
// line 48 "TreeBook.ump"
// line 102 "TreeBook.ump"
public class ForecastTree
{
  ...
  public ForecastTree(String aSpecies, boolean aToBeChopped, Status aStatus, float aHeight, float aDiameterOfCanopy, String aMunicipality, float aDiameterOfTrunk, KindOfLandUse aLandUse, Date aWhenPlanted, int aReports, Date aWhenCutDown, Date aLastSurvey, Location aCoordinates, ForecastSustainabilityAttributes aTreeSustainability)
  {
    species = aSpecies;
    ...
    {
      throw new RuntimeException("Unable to create ForecastTree due to aCoordinates");
    }
    if (!setTreeSustainability(aTreeSustainability))
    {
      throw new RuntimeException("Unable to create ForecastTree due to aTreeSustainability");
    }
  }
  ...
  public boolean setTreeSustainability(ForecastSustainabilityAttributes aNewTreeSustainability)
  {
    boolean wasSet = false;
